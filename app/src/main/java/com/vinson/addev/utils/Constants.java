...
public class Constants {
    ...
    public static final String WS_BASE_URL = "ws://127.0.0.1:8080";
    public static final String WS_PATH = "/api/ws/endpoint";

    public static final String ROOM_PREFIX="ADDEV_ROOM_";
    public static final String STREAM_PREFIX="ADDDEV_STREAM";
